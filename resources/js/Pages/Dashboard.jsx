...
export default function Dashboard({ auth, randomQuestions, tags }) {
    ...
    const [aiAnswers, setAiAnswers] = useState({}); // Store AI answers
    const [loadingAi, setLoadingAi] = useState({}); // Track loading state
    ...
    // Function to fetch AI answer for a question
    const fetchAiAnswer = async (questionId, questionTitle) => {
        ...
        try {
            ...
            const simulatedAiResponse = `This is a simulated AI answer for the question: "${questionTitle}". In a real implementation, this would connect to an AI service like OpenAI or similar to generate a relevant response based on the question content. The AI would analyze the question and provide a detailed, helpful answer.`;
            
            // Simulate API delay
            await new Promise(resolve => setTimeout(resolve, 1500));
            
            // Set the AI answer
            setAiAnswers(prev => ({ ...prev, [questionId]: simulatedAiResponse }));
        } catch (error) {
            console.error('Error fetching AI answer:', error);
            setAiAnswers(prev => ({ ...prev, [questionId]: 'Sorry, there was an error generating the AI answer. Please try again.' }));
        } finally {
                                            ...
                                            <div key={question.id} className="border-b border-gray-200 pb-4 dark:border-gray-700 last:border-0 last:pb-0">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        <button
                                                            onClick={() => fetchAiAnswer(question.id, question.title)}
                                                            disabled={loadingAi[question.id]}
                                                            className="flex items-center space-x-1 rounded-md bg-gradient-to-r from-blue-500 to-indigo-500 px-3 py-1 text-sm font-medium text-white hover:from-blue-600 hover:to-indigo-600 disabled:opacity-50"
                                                        >
                                                ...
                                                {aiAnswers[question.id] && (
                                                    <div className="mt-3 rounded-lg bg-blue-50 p-4 dark:bg-blue-900/30">
                                                        <div className="flex items-center space-x-2">
                                                ...
                                                {loadingAi[question.id] && (
                                                    <div className="mt-3 rounded-lg bg-blue-50 p-4 dark:bg-blue-900/30">
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-md font-medium text-blue-700 dark:text-blue-300">
